export type TopicStatus = 'dev' | 'soon' | 'ready' | 'new' | 'updated' | string;
...
export type TheoryKind = 'definition' | 'theorem' | 'text' | 'remark';

export interface TheoryDisclosure {
  label: string;
  items?: string[];
  content?: string;
}
...
export interface TheoryItem {
  ...
  proof?: string;
  table?: TheoryTable;
  disclosure?: TheoryDisclosure;
  disclosures?: TheoryDisclosure[];
}
